            ...
            <div className="headefr-fexid" data-dsn-header="project">
              ...
              >
                <div
                  ...
                  data-overlay="0"
                  data-image-src="/assets/img/services/section-2/1.webp"
                ></div>
              </div>
              ...
              <div className="project-title" id="dsn-hero-parallax-title">
                <div className="title-text-header">
                  <div className="cat">
                    <span>{translations?.project2?.section1?.subHeading}</span>
                  </div>
                  <span className="title-text-header-inner">
                    <span data-dsn-animate="ajax">
                      {translations?.project2?.section1?.heading}
                    </span>
                  </span>
                </div>
          ...
          <div className="wrapper">
            <div className="root-project">
              <div className="container intro-project section-margin">
                <div className="intro-text text-center">
                  ...
                  <div className="inner">
                    <h2 data-dsn-animate="text">{translations?.project2?.section2?.heading}</h2>
                    <p data-dsn-animate="up">
                      {translations?.project2?.section2?.text}
                    </p>
                ...
                <div className="row">
                  <div className="col-md-4 box-im section-padding">
                    <div className="image-zoom" data-dsn="parallax">
                      <a
                        ...
                        href="/assets/img/services/section-2/2.webp"
                      >
                        <img src="/assets/img/services/section-2/2.webp" alt="" />
                      </a>
                  ...
                  <div className="col-md-4 box-im section-padding">
                    <div className="image-zoom" data-dsn="parallax">
                      <a
                        className="single-image"
                        href="/assets/img/services/section-2/4.webp"
                      >
                        <img src="/assets/img/services/section-2/4.webp" alt="" />
                      </a>
                  ...
                  <div className="col-md-4 box-im section-padding">
                    <div className="image-zoom" data-dsn="parallax">
                      <a
                        className="single-image"
                        href="/assets/img/services/section-2/3.webp"
                      >
                        <img src="/assets/img/services/section-2/3.webp" alt="" />
                      </a>
                      {/* <div className="caption">Sef McCullough</div> */}
                    </div>
                  </div>
            ...
            <div className="next-project" data-dsn-footer="project">
              ...
              <div id="dsn-next-parallax-title" className="project-title">
                <a
                  href={`/${lang}/linz-leonding`}
                  className=""
                  data-dsn-ajax="next-project"
                >
                  <div className="title-text-header">
                    <div className="title-text-header-inner">
                      <span>{translations?.project2?.section3?.heading}</span>
                    </div>
                  </div>
                  <div className="sub-text-header">
                    <h5>{translations?.project2?.section3?.subHeading}</h5>
                  </div>
                </a>
              </div>
            </div>
...
export default HamburgHammerbrook;
